...
def ai_play():
    ...
    env = MazeEnvironment(height=max_size, width=max_size, cell_size=cell_size)
    ...
    for size in range(min_size, max_size+1):
        ...
        for run in range(runs_per_level):
            ...
            while not done:
                ...
                rx = px * cell_size + cell_size // 2 - reward_head.get_width() // 2
                ry = py * cell_size - reward_head.get_height() - 4
